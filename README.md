<<<<<<< HEAD
My new and improved personal website, created using React. Inspired by Tim Baker's React Resume Website Template (https://github.com/tbakerx/react-resume-template).
=======
...
>>>>>>> parent of f0feb22 (Update README.md)
